      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <div className="mb-10">
          ...
          <div className="mt-6 p-4 bg-amber-50 border border-amber-100 rounded-xl text-sm text-amber-800">
            ...
            using the Anika Control OS platform ("Service"), you agree to be
            bound by these Terms of Service and End User License Agreement
        ...
        <div className="space-y-10 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">
              This Agreement is entered into between <strong>{COMPANY}</strong>{" "}
              ("Company," "we," "us," or "our"), a limited liability company,
              and you ("User," "you," or "your") -- whether an individual
              accessing the Service on your own behalf or an authorized
              representative accessing on behalf of an organization.
            </p>
            <p>
              By creating an account, accessing the platform, or using any
              feature of the Service, you represent that you have the legal
              authority to enter into this Agreement, either personally or on
          ...
          <section>
            ...
            <p className="mb-3">
              Anika Control OS is a proprietary logistics dispatch software
            ...
            <p>
              We reserve the right to modify, enhance, suspend, or discontinue
              any feature of the Service at any time with reasonable notice to
              active users.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of any applicable fees, {COMPANY} grants you a limited,
            ...
            <ul className="list-disc list-inside space-y-1 ml-2 text-gray-600">
              <li>
                Copy, modify, or create derivative works of the Service or its
                underlying code
              </li>
              <li>Reverse engineer, decompile, or disassemble the Service</li>
              <li>
                Resell, sublicense, or otherwise commercialize the Service to
                third parties
              </li>
              <li>Use the Service to build a competing product or service</li>
              <li>
                Remove or alter any proprietary notices within the Service
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              when creating your account and using the Service. You are
            ...
            <p className="mb-4">
              ...
              account credentials. You must immediately notify us at{" "}
              <a
            ...
            <ul className="list-disc list-inside space-y-1 ml-2 text-gray-600 mb-4">
              ...
              <li>
                Transmit any unauthorized, unsolicited, or harmful data or
                communications
              </li>
              <li>
              ...
              <li>
                Upload or transmit malicious code, viruses, or destructive
                programs
              </li>
              <li>
                Harass, abuse, or harm any person in connection with use of the
                Service
              </li>
              <li>
            ...
            <p>
              If you use the Service to track driver locations, you represent
              and warrant that you have obtained all necessary consents from
              your drivers in accordance with applicable employment and privacy
              laws. You bear sole responsibility for compliance with applicable
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              but not limited to software code, algorithms, user interface
              design, branding, logos, documentation, and all related
              intellectual property -- are and will remain the exclusive
              property of <strong>{COMPANY}</strong> and its licensors.
            </p>
            <p className="mb-3">
              This Agreement does not transfer any ownership rights to you. The
              "Anika Control OS," "Anika Logistics," and related marks are
              trademarks of {COMPANY}. You may not use these marks without our
              prior written consent.
            </p>
            <p>
              <strong>Your Data:</strong> You retain ownership of all data you
              input into the Service ("Customer Data"). You grant us a limited
              license to process and store your Customer Data solely to provide
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              fees as described in a separate order form, subscription
              agreement, or as communicated at account setup. You agree to:
            </p>
            <ul className="list-disc list-inside space-y-1 ml-2 text-gray-600">
              <li>
              ...
              <li>
                Pay applicable taxes unless you provide a valid tax exemption
                certificate
              </li>
            </ul>
            <p className="mt-3">
              We reserve the right to suspend or terminate access for
              non-payment after reasonable notice. All fees are non-refundable
              except as required by applicable law or as explicitly stated in a
          ...
          <section>
            ...
            <p>
              Each party agrees to keep confidential all non-public, proprietary
              information disclosed by the other party in connection with this
              Agreement, and to use such information only as necessary to
              fulfill obligations under this Agreement. This obligation does not
              apply to information that is publicly known, independently
          ...
          <section>
            ...
            <p className="mb-3">{COMPANY} does not warrant that:</p>
            <ul className="list-disc list-inside space-y-1 ml-2 text-gray-600">
              <li>
              ...
              <li>
                Results obtained from use of the Service will be accurate or
                reliable
              </li>
              <li>
                Any defects in the Service will be corrected within a specific
                timeframe
              </li>
            </ul>
            <p className="mt-3">
              You use the Service at your own risk. Some jurisdictions do not
              allow exclusion of implied warranties, so the above exclusions may
              not apply to you.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              SHALL {COMPANY.toUpperCase()}, ITS OFFICERS, DIRECTORS, EMPLOYEES,
            ...
            <p>
              OUR TOTAL CUMULATIVE LIABILITY TO YOU FOR ALL CLAIMS ARISING UNDER
              OR RELATED TO THIS AGREEMENT SHALL NOT EXCEED THE GREATER OF: (A)
          ...
          <section>
            ...
            <p>
              ...
              (a) your use of the Service; (b) your violation of this Agreement;
              (c) your violation of any third-party rights; or (d) your
          ...
          <section>
            ...
            <p className="mb-3">
              This Agreement begins on the date you first access the Service and
            ...
            <ul className="space-y-2">
              <li className="flex gap-3">
                ...
                <span>
                  <strong className="text-gray-900">By You:</strong> You may
              ...
              <li className="flex gap-3">
                <span className="mt-1 h-2 w-2 flex-shrink-0 rounded-full bg-blue-500" />
                <span>
                  <strong className="text-gray-900">By Us:</strong> We may
                  suspend or terminate your access at any time, with or without
                  cause, including for breach of this Agreement, non-payment, or
              ...
              <li className="flex gap-3">
                ...
                <span>
                  ...
                  immediately. Sections related to intellectual property,
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              with the laws of the <strong>{GOVERNING_STATE}</strong>, without
            ...
            <p className="mb-3">
              ...
              {GOVERNING_STATE} under the rules of the American Arbitration
              Association (AAA), except that either party may seek injunctive or
            ...
            <p>
              ...
              disputes with {COMPANY} only on an individual basis and waive any
          ...
          <section>
            ...
            <p>
              ...
              QuickBooks Online (Intuit Inc.), mapping providers, and cloud
              infrastructure providers. Your use of such integrations is subject
              to the respective third-party's terms of service and privacy
              policies. {COMPANY} is not responsible for the availability,
          ...
          <section>
            ...
            <p>
              ...
              provide notice of material changes by posting the updated
              Agreement within the Service and/or by sending an email to the
              address on file. Your continued use of the Service after such
              notice constitutes your acceptance of the updated terms. If you do
              not agree to the modifications, you must discontinue use of the
              Service.
            </p>
          </section>
