...
export default function BlastLoadDialog({
  ...
  const fetchDrivers = async () => {
    ...
    if (!error && data) {
      ...
      toast({
        title: "Error",
        description: "Failed to load drivers: " + error.message,
        variant: "destructive",
      });
    }
  ...
  const handleSendBlast = async () => {
    ...
    try {
      ...
      try {
        ...
        captureLoadError(load.id, respErr, {
          operation: "create_blast_responses",
          blastId: blast.id,
        });
      ...
      try {
        ...
        captureLoadError(load.id, notifErr, {
          operation: "create_driver_notifications",
          blastId: blast.id,
        });
      ...
      if (blastUpdateErr)
        console.warn(
          "load blast status update failed:",
          blastUpdateErr.message,
        );
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Send this load offer to multiple drivers simultaneously. First to
            accept gets assigned.
          </DialogDescription>
        </DialogHeader>
          ...
          >
            {sending ? (
              ...
              <>
                ...
                Send Blast to {selectedDriverIds.size} Driver
